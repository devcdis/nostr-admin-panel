...
import { ApprovedMerchantsTable } from "../components/merchants/ApprovedMerchantsTable.tsx";
import { MerchantRequestsTable } from "../components/merchants/MerchantRequestsTable.tsx";
    ...
    <DashboardLayout>
      <div className="flex flex-col rounded shadow-sm bg-white overflow-hidden">
        ...
        <div className="p-5 lg:p-6 grow w-full">
          {/* All Merchants */}
          {currentTab === 0 && <ApprovedMerchantsTable />}

          {/* Pending Merchant Requests */}
          {currentTab === 1 && <MerchantRequestsTable />}
        </div>
      </div>
    </DashboardLayout>
  );
